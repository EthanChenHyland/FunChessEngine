...
const WS_GOTHIC_SHAPES={
 p:'M24 5 L30 11 L28 19 L32 23 L29 33 L36 38 L35 41 H13 L12 38 L19 33 L16 23 L20 19 L18 11 Z',
 r:'M11 7 L17 10 L20 7 L24 11 L28 7 L31 10 L37 7 L34 21 L29 25 L31 34 L37 38 L36 41 H12 L11 38 L17 34 L19 25 L14 21 Z',
...
function wsPaintPiece(element,symbol,set=null) {
  ...
  if(token) {
    ...
    if(set==='roundel'){letter.textContent=PIECES[symbol.toLowerCase()] || symbol.toUpperCase();letter.classList.add('ws-token-symbol');}
  }
...
function wsBind() {
  ...
  const controls=[
    [appearance,'whiteSet','White piece set','select',[['vector','Sculpted'],['neo','Neo'],['staunton','Staunton'],['minimal','Minimal'],['geometric','Geometric'],['slim','Slim'],['gothic','Gothic'],['shield','Shield tokens'],['roundel','Roundel symbols'],['hex','Hex notation'],['font','Solid glyphs'],['letters','Letters']]],[appearance,'blackSet','Black piece set','select',[['vector','Sculpted'],['neo','Neo'],['staunton','Staunton'],['minimal','Minimal'],['geometric','Geometric'],['slim','Slim'],['gothic','Gothic'],['shield','Shield tokens'],['roundel','Roundel symbols'],['hex','Hex notation'],['font','Solid glyphs'],['letters','Letters']]],[appearance,'whiteScale','White piece size','range'],[appearance,'blackScale','Black piece size','range'],[appearance,'autoContrast','Automatic outline contrast','checkbox'],[appearance,'outlineStyle','Outline style','select',[['solid','Solid'],['dashed','Engraved']]],[appearance,'shadowColor','Shadow color','color'],[appearance,'fontSymbols','Glyph style','select',[['solid','Filled for contrast'],['classic','Traditional white/black symbols']]],[appearance,'pieceFinish','Piece finish','select',[['matte','Matte'],['flat','Flat'],['gloss','Gloss'],['glass','Glass']]],[appearance,'white','White pieces','color'],[appearance,'black','Black pieces','color'],[appearance,'whiteOutline','White outline','color'],[appearance,'blackOutline','Black outline','color'],[appearance,'outline','Piece outline','range'],[appearance,'pieceShadow','Piece shadow','range'],[appearance,'pieceOpacity','Piece opacity','range'],[appearance,'pieceY','Vertical position','range'],[appearance,'pieceWidth','Piece width','range'],[appearance,'pieceGlow','Glow pieces','checkbox'],
  ...
  const customize=wbButton('Customize board',async()=>{await activateTab(document.querySelector('[data-tab="display"]'));$('wsSettingsSearch').focus({preventScroll:true});requestAnimationFrame(()=>$('wsSettings').scrollIntoView({behavior:wsReduced()?'auto':'smooth',block:'start'}));},'secondary');customize.id='wsCustomizeBoard';$('flipBtn').after(customize);document.querySelector('.board-actions').classList.add('ws-board-actions');
