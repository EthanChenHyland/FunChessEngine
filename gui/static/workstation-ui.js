...
function wsPaintPiece(element,symbol,set=null) {
  ...
  else shape.setAttribute('d',(set==='neo'?WS_NEO_SHAPES:WS_SHAPES)[symbol.toLowerCase()]);
  svg.append(shape);
  if(set==='letters') {
...
function wsGallery() {
  ...
  for(const [set,label] of [['font','Solid glyphs'],['vector','Sculpted'],['neo','Neo'],['letters','Letters']]) {
