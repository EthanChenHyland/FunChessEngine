...
const WS_PIECE_PRESETS=[
  ...
  ['Geometric',{whiteSet:'geometric',blackSet:'geometric',white:'#f9f5e8',black:'#192936',whiteOutline:'#192936',blackOutline:'#f9f5e8',outline:1.8,pieceShadow:22,pieceFinish:'flat'}],
...
const WS_GEOMETRIC_SHAPES={
 p:'M18 7 H30 V19 H27 L31 34 H36 V40 H12 V34 H17 L21 19 H18 Z',
 r:'M12 7 H19 V14 H22 V7 H26 V14 H29 V7 H36 V21 H31 V34 H36 V40 H12 V34 H17 V21 H12 Z',
 b:'M24 5 L33 17 L28 26 L32 34 H37 V40 H11 V34 H16 L20 26 L15 17 Z M24 10 L21 18 L27 21',
 n:'M12 40 V34 L20 26 L14 23 L17 12 L25 10 L29 5 L36 17 L33 31 L38 36 V40 Z M21 15 H24 V18 H21 Z',
 q:'M10 12 L18 25 L24 8 L30 25 L38 12 L32 34 H37 V40 H11 V34 H16 Z M8 8 H14 V14 H8 Z M21 4 H27 V10 H21 Z M34 8 H40 V14 H34 Z',
 k:'M21 3 H27 V8 H32 V14 H27 V18 L34 25 L29 33 H36 V40 H12 V33 H19 L14 25 L21 18 V14 H16 V8 H21 Z'
};
const WS_SLIM_SHAPES={
 p:'M24 6 C29 6 31 10 29 15 C28 18 26 19 26 21 L29 34 L34 38 L34 40 H14 V38 L19 34 L22 21 C22 19 20 18 19 15 C17 10 19 6 24 6 Z',
 r:'M15 7 H19 V13 H22 V7 H26 V13 H29 V7 H33 L32 19 L28 23 L29 34 L34 38 V40 H14 V38 L19 34 L20 23 L16 19 Z',
 b:'M24 4 C29 9 31 14 28 20 L26 24 L29 34 L34 38 V40 H14 V38 L19 34 L22 24 L20 20 C17 14 19 9 24 4 Z M25 10 L21 18',
 n:'M14 40 V36 L20 29 L23 20 L18 24 L13 20 L17 12 L23 10 L26 5 C33 10 36 17 34 25 C33 30 30 33 28 35 L35 38 V40 Z M20 15 H22',
 q:'M12 14 L19 25 L24 8 L29 25 L36 14 L30 33 L35 38 V40 H13 V38 L18 33 Z M10 11 A2 2 0 1 0 14 11 A2 2 0 1 0 10 11 M22 6 A2 2 0 1 0 26 6 A2 2 0 1 0 22 6 M34 11 A2 2 0 1 0 38 11 A2 2 0 1 0 34 11',
 k:'M22 3 H26 V8 H30 V12 H26 V17 C32 18 34 23 31 28 L27 33 L35 38 V40 H13 V38 L21 33 L17 28 C14 23 16 18 22 17 V12 H18 V8 H22 Z'
};
function wsPaintPiece(element,symbol,set=null) {
  ...
  const shape=document.createElementNS(svg.namespaceURI,set==='letters'?'circle':set==='shield'?'polygon':'path');
  ...
  else shape.setAttribute('d',({neo:WS_NEO_SHAPES,staunton:WS_STAUNTON_SHAPES,minimal:WS_MINIMAL_SHAPES,geometric:WS_GEOMETRIC_SHAPES,slim:WS_SLIM_SHAPES}[set] || WS_SHAPES)[symbol.toLowerCase()]);
  svg.append(shape);
  if(set==='letters' || set==='shield') {
...
function wsGallery() {
  ...
  for(const [set,label] of [['font','Solid glyphs'],['vector','Sculpted'],['neo','Neo'],['staunton','Staunton'],['minimal','Minimal'],['geometric','Geometric'],['slim','Slim'],['shield','Shield'],['letters','Letters']]) {
