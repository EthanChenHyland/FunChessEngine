...
- Choose Sculpted, Neo, Staunton, Minimal, Geometric, Slim, Shield, filled glyph, or letter-token pieces independently for White
...
- Apply one-click Maximum clarity, Tournament, Flat modern, Study letters,
  ...
  Slimline, or Shield token recipes.
