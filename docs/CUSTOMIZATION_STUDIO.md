...
- Choose Sculpted, Neo, Staunton, Minimal, Geometric, Slim, Gothic, Shield,
  Roundel, Hex, filled glyph, or letter-token pieces independently for White
...
- Apply one-click Maximum clarity, Tournament, Flat modern, Study letters,
  Classic solid, Glass token, Staunton club, Minimal analysis, Geometric,
  Slimline, Shield token, Gothic court, Roundel symbol, or Hex notation recipes.
